...
(. + doOAuth)
  | ($$authToken as httpPost("https://todoist.com/oauth/access_token"; {client_id, client_secret, code, redirect_uri}; {}; {}) | .access_token in
     $$syncResults as httpPost("https://todoist.com/API/v7/sync"; {token: $$authToken, sync_token: "*", resource_types: "[\"projects\",\"items\"]"}; {}; {}) in
