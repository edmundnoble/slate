...
object RanTraverseM {
  def singleton[R, T[_], I, O](arr: I => Eff[R, T[O]]): RanTraverseM[R, T, I, O] =
    Leaf[R, T, I, O](arr)
  ...
  def run[R: _taskPar, T[_] : Traverse : Monad, I, O](rt: RanTraverseM[R, T, I, O])(i: I): TaskParallel[Eff[R, T[O]]] = rt match {
    case Encompose(rts) =>
