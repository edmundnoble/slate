...
object SerializationBench {
  ...
  val selectKeyBuilder: Benchmark.Builder[Int, ConcreteFilter] =
    Benchmark.setup[Int, ConcreteFilter](i => Util.composeBuildRec[Fix](i, FilterDSL.fix.selectKey("key")))
  val idBuilder: Benchmark.Builder[Int, ConcreteFilter] =
    Benchmark.setup[Int, ConcreteFilter](i => Util.composeBuildRec[Fix](i, FilterDSL.fix.id))
